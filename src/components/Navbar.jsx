...
function Navbar() {
  ...
  // About Us Dropdown links array (Overview removed)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-28">
          ...
          <div className="hidden lg:flex items-center space-x-7 text-base font-semibold text-slate-700">
            ...
            >
              <Link to="/about" className="relative group hover:text-[#1c296b] transition-colors duration-200 flex items-center gap-1.5 cursor-pointer">
                About Us 
                <motion.i 
              ...
              <AnimatePresence>
                {isAboutDropdownOpen && (
                  <motion.div 
                    ...
                    className="absolute top-full -left-4 w-52 bg-white rounded-2xl shadow-2xl border border-slate-100 py-3 z-50 mt-2 overflow-hidden"
                  >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <Link to="/about" onClick={() => setIsOpen(false)} className="block text-slate-700 hover:text-[#1c296b] font-semibold py-2 transition-colors">About Us</Link>
            ...
            <div className="pt-3 space-y-2.5">
              <Link to="/book-a-free-consult" onClick={() => setIsOpen(false)}
               className="relative overflow-hidden bg-[#1c296b] hover:bg-red-600 text-white text-base font-bold px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg hover:shadow-red-600/40 transform hover:-translate-y-0.5 active:translate-y-0 text-center block">
                Book Appointment
              </Link>
              <Link to="/donat-now" onClick={() => setIsOpen(false)} className="flex items-center justify-center gap-1.5 text-center bg-red-600 hover:bg-red-700 text-white text-sm font-bold px-6 py-3 rounded-full shadow-md transition-all duration-300">
                <span className="text-lg font-bold">+</span>
                <span>Donate Now</span>
              </Link>
            </div>
